...
EVENT_CATALOG = {
    "Certificate Authorities": [
        ...
        ("reissue_ca_certificate", "CA certificate re-issued"),
        ("cross_sign_ca", "CA cross-signed by another CA"),
        ("import_ca_certificate", "Alternate CA certificate imported"),
        ("approve_ca_certificate", "Alternate CA certificate approved (dual control)"),
        ("delete_ca_certificate", "Alternate CA certificate removed"),
    ...
    "ACME": [
        ("update_ca_acme", "ACME settings of a CA changed"),
        ("create_acme_eab_key", "ACME external account binding key issued"),
        ("revoke_acme_eab_key", "ACME external account binding key revoked"),
        ("acme_account_created", "ACME account registered"),
        ("acme_account_deactivated", "ACME account deactivated"),
        ("acme_key_changed", "ACME account key rolled over"),
        ("acme_order_created", "ACME order created (can be noisy)"),
        ("acme_challenge_validated", "ACME challenge validated"),
        ("acme_challenge_failed", "ACME challenge failed"),
        ("acme_certificate_issued", "Certificate issued through ACME"),
    ...
    "Users & authentication": [
        ...
        ("logout", "Logout"),
        ("login_2fa_failed", "Second-factor code rejected (can be noisy)"),
        ("totp_enabled", "Two-factor authentication enabled"),
        ("totp_disabled", "Two-factor authentication disabled"),
        ("totp_reset", "Two-factor authentication reset by an admin"),
